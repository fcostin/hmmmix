...
This form of MAP estimate becomes computationally tractable because the probabilities of each component HMM state $(X_i, Z_i)$ are conditionally independent from $(X_j, Z_j)$ $j \neq i$ given $Z$, allowing conditional probabilities to be calculated independently component by component once some value of $Z$ is fixed. This leads to a tractable decomposition of the problem. \todo{explain in terms of causal graph diagram, markov blankets, d separation}
